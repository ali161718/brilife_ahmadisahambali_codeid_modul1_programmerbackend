...
class ProviencesPage extends Component {
    ...
    reload() {
        this.props.findAll(this.state.params, 'province');
    }
...
const mapStateToProps = state => ({
    data: state.findsProvience.data,
    loading: state.findsProvience.loading,
    error: state.findsProvience.error
});
...
export default withStyles(styles, {withTheme: true})(
    connect(mapStateToProps, mapDispatchToProps)(ProviencesPage)
);
